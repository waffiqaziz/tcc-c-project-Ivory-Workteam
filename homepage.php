						...
						<li>
							<div class="dropright m-1">
								...
								<div class="dropdown-menu shadow" aria-labelledby="dropdownMenuButton">
									...
									$data = "user_id=$id";
									$result = callAPI("GET", $localhost . "showProjectTitle/$id", $data);
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
				...
				<div class="project-display container ">
					<div class="row row-cols-* m-auto">
						...
						<?php
						$data = "user_id=$id";
						$result = callAPI("GET", $localhost . "getProjectByUserID/$id", $data);
						...
						?>
								<div class="card m-3 col-md-3 shadow" style="width: 28rem;">
									<div class="card-body">
										<h5 class="card-title"><?php echo $resultData[$i]['title'] ?>
											<!-- disini ada sedikit javascript untuk mengoper nilai projectid -->
											<button id="editparent" bikinan="<?php echo $resultData[$i]["project_id"] ?>" data-toggle="modal" type="button" data-target="#myModal" class="btn text-danger p-0">
										...
										<?php 
										$tempDate = date('Y-m-d', strtotime($resultData[$i]["deadline"]));
										$fixDate = date('l', strtotime($tempDate));
										?>
										<h6 class="card-subtitle mb-2 text-danger small"><?php echo $fixDate.", ".$tempDate  ?></h6>
										<p class="card-text"><?php echo $resultData[$i]['description'] ?></p>
										<a href="./detail.php?id=<?php echo $resultData[$i]['project_id']  ?>" class="card-link">Detail</a>
									</div>
								</div>
						<?php
							}
