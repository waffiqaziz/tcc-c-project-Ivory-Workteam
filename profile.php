...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<?php
			$result = callAPI("GET", $localhost . "getDataUser/$user_id", $data);
			if ($result["error"] == 0) { // check if theres project or not
				$resultData = $result["data"];
			}
			?>
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
				...
				<div class="col-xs-12 col-sm-8 bg-secondary rounded shadow-lg text-light m-auto p-5" style="margin-top: 250px;">
					<h2 style="text-shadow: 2px 2px 2px #000000;"><?php echo $resultData[0]["name"] ?></h2>
					<div style="text-shadow: 2px 2px 5px #000000;">
						<p><strong>About: </strong><?php echo $resultData[0]["about"] ?></p>
						<p><strong>Hobbies: </strong><?php echo $resultData[0]["hobby"] ?></p>
						<p><strong>Skills: </strong>
							<span class="tags"><?php echo $resultData[0]["skill"] ?></span>
						</p>
				...
				<form method="POST" action="./action_editprofile.php">
					<div class="modal-body">
						<div class="form-group">
							...
							<input name="name" type="text" class="form-control shadow" id="exampleInputjudul" aria-describedby="judulHelp" placeholder="Enter your name" value="<?php echo $resultData[0]["name"];?>">
						</div>
						<div class="form-group">
							<label for="exampleInputjudul">About</label>
							<textarea name="about" type="text" class="form-control shadow" id="exampleInputjudul" aria-describedby="judulHelp" placeholder="Enter description about you"><?php echo $resultData[0]["about"];?></textarea>
						</div>
						<div class="form-group">
							<label for="exampleInputjudul">Hobbies</label>
							<input name="hobby" type="text" class="form-control shadow" id="exampleInputjudul" aria-describedby="judulHelp" placeholder="Enter your hobbies" value="<?php echo $resultData[0]["hobby"];?>">
						</div>
						<div class="form-group">
							<label for="exampleInputjudul">Skills</label>
							<input name="skill" type="text" class="form-control shadow" id="exampleInputjudul" aria-describedby="judulHelp" placeholder="Enter your skills" value="<?php echo $resultData[0]["skill"];?>">
						</div>
